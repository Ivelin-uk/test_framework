...
<body class="bg-body-tertiary">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="<?= $this->url() ?>">🚀 Моят Framework</a>
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?= $this->url('about') ?>">За нас</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?= $this->url('contact') ?>">Контакти</a></li>
